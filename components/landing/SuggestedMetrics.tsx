      ...
      <div className='flex flex-col gap-6'>
        ...
        <div className='grid grid-cols-1 gap-2.5 lg:grid-cols-[minmax(0,1.45fr)_minmax(0,1fr)]'>
            ...
            <div className='relative min-h-[182px] overflow-hidden bg-[var(--Neutral-100,#171717)] p-3'>
              <div className='flex items-start justify-between gap-3'>
                ...
                <Link
                  ...
                  className='shrink-0 font-mono text-sm font-normal leading-[1.4] tracking-[-0.02em] text-[color:var(--Primary-500,#5747ff)]'
          ...
          <PanelReveal visible={inView} staggerMs={280}>
            ...
            >
              <p className='font-sans text-xs font-normal leading-[1.4] text-[color:var(--Primary-500,#5747ff)]'>
                Projected Revenue
              </p>
              <CountRevenue
                active={inView}
