    ...
    >
      <div className='flex w-full flex-col gap-6'>
        <p className='font-sans text-xs font-normal leading-[1.4] text-[color:var(--Neutral-500,#737373)]'>
          Drag to set your monthly mailboxes
        </p>
        ...
        <div className='w-full'>
          <div className='relative mx-[5px] h-6 w-[calc(100%-10px)] max-w-full'>
            ...
            <div
              className='absolute left-0 top-1/2 h-1 -translate-y-1/2 bg-[color:var(--Primary-500,#5747ff)]'
              style={{ width: `${pct * 100}%` }}
            />
            <div
            ...
            <input
              ...
              aria-valuemax={MAX}
              aria-valuenow={value}
              aria-label='Monthly mailboxes target'
            />
          </div>
      ...
      <div className='flex w-full flex-col gap-2.5'>
        ...
        <Link
          ...
          className='inline-flex items-center gap-1 self-start py-3 font-mono text-sm font-normal leading-[1.4] tracking-[-0.02em] text-[color:var(--Primary-500,#5747ff)]'
